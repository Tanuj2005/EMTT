...
// type Msg = { role: "user" | "assistant"; content: string; sources?: SourceChunk[] };
...
//       setStatus(`Indexed ${data.segments_indexed} transcript segments for video ${data.video_id}`);
//       setMessages([]);
//     } catch (e: any) {
...
//       setMessages((m) => [
//         ...m,
//         { role: "assistant", content: e.message || "Failed to get answer" },
//       ]);
//     } finally {
//       setLoadingAsk(false);
//     }
...
//       <h1 className="text-2xl font-bold">YouTube Transcript RAG Chat</h1>
...
//           <button
//             onClick={onIndex}
//             disabled={loadingIndex || !youtubeUrl}
//             className="border rounded px-4 py-2"
//           >
//             {loadingIndex ? "Indexing..." : "Index"}
//           </button>
//         </div>
//         {videoId && <p className="text-sm">Active video ID: <b>{videoId}</b></p>}
//         {status && <p className="text-sm">{status}</p>}
//       </section>

//       <section className="space-y-2">
//         <label className="text-sm font-medium">Ask about this video</label>
//         <div className="flex gap-2">
//           <input
//             className="border rounded px-3 py-2 w-full"
//             value={question}
...
//             <p className="text-xs uppercase opacity-60 mb-1">{m.role}</p>
...
//                   {m.sources.map((s, idx) => (
//                     <li key={idx}>{s.citation || "unknown source"}</li>
//                   ))}
//                 </ul>
//               </details>
//             )}
